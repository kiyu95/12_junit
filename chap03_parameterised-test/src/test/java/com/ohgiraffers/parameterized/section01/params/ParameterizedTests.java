...
class ParameterizedTests {
    ...
    /*
    * 테스트 시 에러 값들을 검증을 해야 하는 모든 경우의 수 만큼 테스트 메소드를 작성해야 한다.
    ...
    * given when then 패턴에서 사전에 테스트를 위해 준비하던 given 부분을 대체할 수 있게된다.
    * */
    ...
    * */
    ...
    void testIsNull(String input){
        ...
        // when
        boolean result = StringValidator.inNull(input);
    ...
    // 열거형에 작성한 타입들을 파라미터로 전달하여 테스트에 활용할 수 있다.
    ...
    void testMonthValueIsCollect(Month month){
        ...
        // when
        boolean result = DataValidator.inCollect(month);
    ...
    void testHasThirtyOneDaysLong(Month month){ // given : month
    ...
    * */
    ...
    void testToUpperCase(String input, String verifyValue){ // input = test, tEst, JavaScript / verifyValue = TEST, TEST, JAVASCRIPT
