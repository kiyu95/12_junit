...
public class AdditionalAnnotationTests {
    ...
    /*
    * 해당 테스트를 무시할 때 사용하는 어노테이션 이다.
    * Junit4 에서 @Ignore와 동일한 기능을 제공한다.
    * */
    @Disabled
    @Test
    ...
    * */
    ...
    public void testTimeout() throws InterruptedException{
        Thread.sleep(900); // 1000 넘어가면 에러발생 
    }
    ...
    * 테스트의 순서가 중요한 경우도 있다.
    * 클래스 레벨에서 @TestMethodOrder(MethodOrder.OrderAnnotation.class)어노테이션을 추가하고
