...
public class AssertJTests {
    ...
    * 가장 직관적이고 편하며, junit5 팀에서도 공식적으로 추천하고 있는 third party lib 이다. (third party lib = 제 3자가 제공하는 라이브러리)
    * */
    ...
    // 날짜 객체가 가지는 년,월,일,시,분,초 밀리초, 나초로 까지도 검증이 가능하며, 특정 날짜 범위, 이전, 이후 내용도 검증이 가능하다.
    @Test
    ...
    void testExceptionValidation(){
        ...
        // given
        // when
        Throwable thrown = AssertionsForClassTypes.catchThrowable(() -> {throw new IllegalArgumentException("잘못된 파라미터");});
